...
import (
	...
	"github.com/Anwert/fyne/v2/cmd/fyne/internal/util"
...
func runBuildImpl(cmd *command) (*packages.Package, error) {
	...
	if !nmpkgs["github.com/Anwert/fyne/v2/internal/driver/mobile/app"] {
		return nil, fmt.Errorf(`%s does not import "github.com/Anwert/fyne/v2/internal/driver/mobile/app"`, pkg.PkgPath)
	}
...
func extractPkgs(nm string, path string) (map[string]bool, error) {
	if buildN {
		return map[string]bool{"github.com/Anwert/fyne/v2/internal/driver/mobile/app": true}, nil
	}
	r, w := io.Pipe()
